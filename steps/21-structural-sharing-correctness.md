...
depends_on:
  ...
  - copy-on-write-correctness-spec
...
Implement true node immutability and verify structural sharing correctness to ensure unchanged subtrees share the exact same node instances across versions, as specified in the [Structural Sharing Requirement](../pkg/_blueprint/reliability/structural-sharing/requirement.md).
...
- [Structural Sharing Requirement](../pkg/_blueprint/reliability/structural-sharing/requirement.md)
- [Copy-on-Write Correctness Spec](../pkg/_blueprint/reliability/structural-sharing/_specs/copy-on-write-correctness.md)
- [ADR: Structural Sharing Strategy](../pkg/tree/_blueprint/_decisions/structural-sharing-strategy.md)
