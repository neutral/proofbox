...
This guide defines **how the `blueprint/steps/` folder drives code‑generation work**. Each file represents a _single, compilable change_ that an LLM agent (or human) can complete end‑to‑end. Ongoing maintenance and refactoring live elsewhere; **Steps track only forward‑moving implementation tasks.**
...
1. **Zero‑padded sequence:** `01-`, `02-`, … keeps steps naturally ordered and defines execution order.
   **Rule:** _Once committed, a number never changes._
