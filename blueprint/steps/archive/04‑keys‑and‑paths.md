...
- **NodeKey Encoding Specification** (`/blueprint/features/metadata/versions/specs/nodekey-encoding.md`)
- **Versioned Keys Specification** (`/blueprint/features/metadata/versions/specs/versioned-keys.md`)
- **Common Definitions** (`/blueprint/global/specs/common-definitions.md`)
