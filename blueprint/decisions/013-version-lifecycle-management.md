...
## Context
The Jellyfish Merkle Tree needs to support multiple versions for blockchain state management. This requires careful management of version states to prevent inconsistencies and resource leaks.
